...
open class QuickVH(var itemView: View) : QuickVHService {
    ...
    override fun setText(
        @IdRes id: Int, content: CharSequence?,
    ...
    override fun setImgRoundRect(
        @IdRes id: Int, radius: Float, @DrawableRes iconId: Int,
        onClickListener: ((view: View, VHService: QuickVHService) -> Unit)?
    ): QuickVHService {
    ...
    private fun setImg(
        ...
        isCir: Boolean,
        radius: Float,
        url: CharSequence, @DrawableRes imgRes: Int,
        onClickListener: ((view: View, VHService: QuickVHService) -> Unit)?
    ): QuickVHService {
